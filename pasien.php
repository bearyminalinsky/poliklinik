...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id) {
        ...
        // Add new doctor
        $query = "INSERT INTO pasien (nama, alamat, no_hp) 
        ...
        <tbody>
            ...
            while ($data = mysqli_fetch_array($result)) {
                echo "<tr>
                        ...
                        <td>
                            <a href='index.php?page=pasien&id={$data['id']}' class='btn btn-warning btn-sm'>Ubah</a> 
                            <a href='pasien.php?aksi=hapus&id={$data['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this doctor?\");'>Hapus</a>
                        </td>
                      </tr>";
                $no++;
            }
